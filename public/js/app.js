...
$("#update-entity").submit(function (event) {
    ...
    axios.put(base_api + '/account/update', data).then(function (response) {
        location.reload();
    }).catch(function (error) {
        errors.record(error.response.data.details);
        errors.show();
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(12), __webpack_require__(5)))
...
$("#btn-delete-entity").on('click', function (evt) {
    ...
    __WEBPACK_IMPORTED_MODULE_2_sweetalert___default()({
        ...
        if (willDelete) {
            var entity_id = $(_this).attr("data-entity-id");

            axios.delete(base_api + '/users/' + entity_id, {}).then(function (response) {
                window.location.href = '/users';
            }).catch(function (error) {
                console.log(error);
                toastr.error('Something went wrong');
...
$("#search-form").submit(function (event) {
    __WEBPACK_IMPORTED_MODULE_0__helper_js__["a" /* default */].startLoading();
    var data = __WEBPACK_IMPORTED_MODULE_0__helper_js__["a" /* default */].getFormResults(this);
    var query = __WEBPACK_IMPORTED_MODULE_0__helper_js__["a" /* default */].encodeQueryData(data);
...
$("#update-entity").submit(function (event) {
    ...
    if (data['id'] !== undefined) {
        ...
        // NEW
        axios.post(base_api + '/contacts', data).then(function (response) {
...
$("#btn-delete-entity").on('click', function (evt) {
    ...
    __WEBPACK_IMPORTED_MODULE_2_sweetalert___default()({
        ...
        if (willDelete) {
            ...
            axios.delete(base_api + '/contacts/' + entity_id, {}).then(function (response) {
                window.location.href = '/contacts';
            }).catch(function (error) {
                console.log(error);
            });
...
$("#update-note").submit(function (event) {
    ...
    if (data['id'] !== undefined && data['id'] !== "") {
        ...
        // NEW
        axios.post(base_api + '/notes', data).then(function (response) {
            $('#note-update-modal').modal('hide');
            $(".notes-container").html(response.data.data);
            __WEBPACK_IMPORTED_MODULE_0__helper_js__["a" /* default */].endLoading();
        }).catch(function (error) {
...
$("#update-entity").submit(function (event) {
    ...
    if (data['id'] !== undefined) {
        // UPDATE
        axios.put(base_api + '/roles/' + data['id'], data).then(function (response) {
            console.log(response.data);
            location.reload();
        }).catch(function (error) {
            errors.record(error.response.data.details);
        ...
        // NEW
        axios.post(base_api + '/roles', data).then(function (response) {
...
$("#btn-delete-entity").on('click', function (evt) {
    ...
    __WEBPACK_IMPORTED_MODULE_2_sweetalert___default()({
        ...
        if (willDelete) {
            ...
            axios.delete(base_api + '/roles/' + entity_id, {}).then(function (response) {
                window.location.href = '/roles';
            }).catch(function (error) {
                console.log(error);
            });
...
$("#update-entity").submit(function (event) {
    ...
    if (data['id'] !== undefined) {
        // UPDATE
        axios.put(base_api + '/permissions/' + data['id'], data).then(function (response) {
            console.log(response.data);
            location.reload();
        }).catch(function (error) {
            errors.record(error.response.data.details);
        ...
        // NEW
        axios.post(base_api + '/permissions', data).then(function (response) {
...
$("#btn-delete-entity").on('click', function (evt) {
    ...
    __WEBPACK_IMPORTED_MODULE_2_sweetalert___default()({
        ...
        if (willDelete) {
            ...
            axios.delete(base_api + '/permissions/' + entity_id, {}).then(function (response) {
                window.location.href = '/permissions';
            }).catch(function (error) {
                console.log(error);
            });
